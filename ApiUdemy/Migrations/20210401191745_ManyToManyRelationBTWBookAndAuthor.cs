...
{
    public partial class ManyToManyRelationBTWBookAndAuthor : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Book_Authors", x => x.BookAuthorId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Book_Authors_LibBook_BookId",
                        column: x => x.BookId,
                        principalTable: "LibBook",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_LibBook_Publishers_PublisherId",
                table: "LibBook",
                column: "PublisherId",
